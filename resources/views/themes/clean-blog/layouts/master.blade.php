...
@include('themes.clean-blog.partials.header')
    ...
    <hr>
 @include('themes.clean-blog.partials.footer')
</div>
    <!-- jQuery -->
    <script src="/clean-blog/vendor/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/clean-blog/vendor/bootstrap/js/bootstrap.min.js"></script>

    <!-- Contact Form JavaScript -->
    <script src="/clean-blog/js/jqBootstrapValidation.js"></script>
    <script src="/clean-blog/js/contact_me.js"></script>
